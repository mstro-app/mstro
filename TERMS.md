...
To use any payment feature of the Service -- including subscriptions -- you must be at least **18 years old** (or the age of majority in your jurisdiction, if higher). You represent that you meet this requirement before enabling any payment feature.
...
- **You bear full responsibility** for any AI-generated code that you deploy, distribute, publish, or integrate into products or services.
...
### 9.1 CLI (Source Available)

The Mstro CLI tool is licensed under the PolyForm Noncommercial License 1.0.0. You may view, modify, and distribute the source code for noncommercial purposes only. Any commercial use of the source code or derivative works thereof requires a separate commercial license from Mstro, Inc. A copy of the PolyForm Noncommercial 1.0.0 license is included in the repository as LICENSE.
...
**15.1** IN NO EVENT SHALL MSTRO, INC. BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, LOSS OF DATA, LOSS OF GOODWILL, SERVICE INTERRUPTION, COMPUTER DAMAGE, OR THE COST OF SUBSTITUTE SERVICES, ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OR YOUR USE OF THE SERVICE, EVEN IF MSTRO HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.

**15.2** MSTRO'S TOTAL CUMULATIVE LIABILITY TO YOU FOR ANY CLAIMS ARISING OUT OF OR RELATED TO THESE TERMS OR THE SERVICE SHALL NOT EXCEED THE GREATER OF: (A) THE AMOUNT YOU PAID TO MSTRO IN THE TWELVE MONTHS PRECEDING THE CLAIM, OR (B) ONE HUNDRED U.S. DOLLARS ($100).

**15.3** THESE LIMITATIONS APPLY REGARDLESS OF THE LEGAL THEORY ON WHICH THE CLAIM IS BASED. SOME JURISDICTIONS DO NOT ALLOW CERTAIN LIMITATIONS OF LIABILITY; IN SUCH JURISDICTIONS, MSTRO'S LIABILITY IS LIMITED TO THE MINIMUM EXTENT PERMITTED BY LAW.
...
If informal resolution fails, **you and Mstro agree that any dispute, claim, or controversy arising out of or relating to these Terms or the Service shall be resolved by binding individual arbitration**, rather than in court, except as set forth in Section 16.5 below. This applies to all claims regardless of legal theory.
...
Upon termination, your right to use the Service ends. Sections 6, 7, 9, 13, 14, 15, 16, 17, and any other provisions that by their nature should survive, will survive termination.
