...
Local server and CLI that runs on the user's machine. Published to npm as `mstro`. Executes Claude Code workflows via improvise mode and connects to the platform via WebSocket relay.
